...
% Users can include this effect by specifying the present-day CMB temperature $T_\text{CMB,0}$, the effective number of ultra-relativistic (massless) species $N_\mathrm{ur}$, the number of massive neutrino species $N_\nu$, the present-day neutrino temperature $T_{\nu,0}$, and $N_\nu$ nonzero neutrino masses $m_{\nu,i}$ $(m_{\nu,i}\neq 0, i=1,\dots,N_\nu)$ and degeneracies $g_i$, $i=1,\dots,N_\nu$.

...
__attribute__((always_inline)) INLINE static void hydro_end_density(
  ...
  p->rho_bar += p->mass * p->entropy_one_over_gamma * corrected_kernel_root;
  p->density.rho_dh -= hydro_dimension * p->mass * corrected_kernel_root;
  p->density.pressure_dh -= hydro_dimension * p->mass *
                            p->entropy_one_over_gamma * corrected_kernel_root;

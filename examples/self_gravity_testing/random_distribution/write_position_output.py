...
file_list = glob.glob("random_*")
n_snaps = 1002

# get the box size
filename = "random_000.hdf5"
...
out_filename = "./data/orbit_r_%d_mle_%d_m_%d_theta_%d.dat" %(int(orbit_radius),int(-np.log10(eta)),m_order,int(np.rint(theta)))

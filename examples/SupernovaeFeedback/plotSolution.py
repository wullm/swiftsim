...
sim = h5py.File("SN_feedback_%04d.hdf5"%snap, "r")
...
text(-0.49, 0.9, "SN feedback with  $\\gamma=%.3f$ in 3D at $t=%.2f$"%(gas_gamma,time), fontsize=10)
...
savefig("SN_feedback.png", dpi=200)

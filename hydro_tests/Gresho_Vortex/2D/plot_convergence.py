...
# Plots the convergence rate for the 2D Gresho vortex test using different
# numbers of cells
...
ax.set_title("2D Gresho vortex convergence")
ax.set_xlabel("Number of particles")
ax.set_ylabel(r"$\langle{}\chi{}^2\rangle{}$")
ax.legend(loc = "best")
pl.tight_layout()
pl.savefig("GreshoVortex_2D_convergence.png")

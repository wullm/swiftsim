...
# result and the analytic solution, both for the total solution and for the
# three characteristic waves present in the solution.
...
sim = h5py.File("sodShock_{snap:04d}.hdf5".format(snap = snap), "r")
...
times = np.loadtxt("timesteps_1.txt")
